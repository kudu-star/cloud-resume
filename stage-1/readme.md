...
22. Map the permanent subdomain to the CDN endpoint by creating a CNAME record that maps <subdomain-alias>.<custom-domain-name> to the host name of the CDN endpoint. 
    
For example, if your custom domain name is www.contoso.com and your CDN endpoint host name is contoso.azureedge.net, create a CNAME record that maps www.contoso.com to contoso.azureedge.net.
